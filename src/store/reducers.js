...
import {reducer_0, global_actions} from './globalAction'
...
export const handleClassForAsync = (store) => ({name, actions, reducer, actionName = 'actions'}) => clazz => {
  ...
  }), dispatch => ({[actionName]: bindActionCreators(actions, dispatch),
  'global_actions': bindActionCreators(global_actions, dispatch)}))(clazz);
}
